...
namespace TokenContent { 
    ...
    extern std::map<int,paragraph> paragraphs;
}
...
// extern std::map<int, Token> command_map;

// extern std::vector<std::string> rules_arr;
...
inline std::string get_file_contents(char *textfile) {
...
inline void print_ll(Token* head){
